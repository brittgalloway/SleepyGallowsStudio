  ...
  return (
    <article>
      ...
      <p className="has-text-justified indent">
        ...
        magic of many cultures in the way only animation can. The Sleepy
        Gallows Studio makes shows and shorts to give children of color
        heroes that look like them. Heroes their people have had all along. And
        to do so in such a way that even adults will be captivated by
        how much magic is still on earth. We want to broaden what your idea of a
        fairytale can be.
      </p>
      <p className="has-text-justified indent">
        We live in realm of whimsy to bring Native American, African,
        African American, and Indian mythology, legends; and
        triumphs to western film and animation in ways we haven’t seen before.
        We love fairytales/mythology and legends that blur truth and
      ...
      <p className="has-text-justified indent">
        Join us in our first dream, <Link to="/Animation/originals/plh">For Peace, Love, and Harmony (PLH)
        </Link>, a 7
